...
import { updateCourseGroupImage } from "@/lib/course-groups/course-group-service";
import {
  isAllowedCourseGroupImageFile,
} from "@/lib/course-groups/course-group-storage";
...
export async function POST(
  ...
  const result = await updateCourseGroupImage(groupId, file.name, bytes);
