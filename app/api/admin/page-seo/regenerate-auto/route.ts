...
import { queueRegenerateAutoPageSeo } from "@/lib/page-seo/page-seo-service";
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    const queued = await queueRegenerateAutoPageSeo();
    ...
    return jsonFromAuthResult({
      ...
      error: {
        code: "INTERNAL_ERROR",
        message: error instanceof Error ? error.message : "Neugenerierung fehlgeschlagen.",
      },
    });
  }
}
