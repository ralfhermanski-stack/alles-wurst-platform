  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 px-4 py-8 sm:px-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-aw-muted">
            Gruppen erscheinen im Kurskatalog zur Orientierung. Pro Gruppe kannst du ein
            Titelbild, optional Module und zugeordnete Kurse pflegen (beim Kurs
            unter Gruppen wählen). Ohne eigenes Bild wird ein Platzhalter angezeigt.
          </p>
        </div>
      </div>
      ...
      <section className="rounded-xl border border-aw-border bg-aw-surface/40 p-5">
        <h2 className="font-semibold text-aw-cream">Neue Gruppe</h2>
        ...
        <div className="mt-4">
          ...
          <p className="mt-2 text-xs text-aw-muted">
            Das Titelbild lädst du nach dem Anlegen in der jeweiligen Gruppe hoch.
          </p>
        </div>
      </section>

      <section className="space-y-4">
        <h2 className="font-semibold text-aw-cream">Gruppen</h2>

        {groups.length === 0 ? (
          <p className="text-sm text-aw-muted">Noch keine Gruppen angelegt.</p>
        ) : (
          ...
          <div className="mt-6 space-y-4">
            {visibleSubgroups.length === 0 ? (
              <p className="text-sm text-aw-muted">
                Noch keine Module in dieser Gruppe.
              </p>
            ) : (
                  ...
                  >
                    ...
                    {isEditing && (
                      <div className="mt-4 grid gap-4 border-t border-aw-border pt-4 sm:grid-cols-2">
                        ...
                        <div>
                          <label className={labelClassName}>Gruppe</label>
                          <select
                            className={`${inputClassName} mt-2`}
