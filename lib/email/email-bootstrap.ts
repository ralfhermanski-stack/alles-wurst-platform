...
const TEMPLATE_SEEDS: Array<{
  ...
  {
    key: "ticket.staff.created",
    name: "Staff — Neues Ticket",
    category: "TICKET",
    subject: "Neues Support-Ticket {{ticketNumber}}: {{subject}}",
    htmlContent: `<p>Neues Support-Ticket <strong>{{ticketNumber}}</strong>.</p><p><strong>Betreff:</strong> {{subject}}<br/><strong>Priorität:</strong> {{priority}}<br/><strong>Kategorie:</strong> {{categoryName}}<br/><strong>Von:</strong> {{userDisplayName}} ({{userEmail}})</p><p>{{bodyHtml}}</p>${actionButtonHtml("Im Admin öffnen", "{{adminUrl}}")}`,
    textContent:
      "Neues Support-Ticket {{ticketNumber}}: {{subject}}\n\nPriorität: {{priority}}\nKategorie: {{categoryName}}\nVon: {{userDisplayName}} ({{userEmail}})\n\n{{adminUrl}}\n",
    allowedVariables: [
      "ticketNumber",
      "subject",
      "priority",
  ...
  {
    key: "ticket.staff.reply",
    name: "Staff — Nutzerantwort",
    category: "TICKET",
    subject: "Nutzerantwort zu Ticket {{ticketNumber}}",
    htmlContent: `<p>Neue Nutzerantwort zu Ticket <strong>{{ticketNumber}}</strong> ({{subject}}).</p><p><strong>Von:</strong> {{userDisplayName}} ({{userEmail}})</p><p>{{bodyHtml}}</p>${actionButtonHtml("Im Admin öffnen", "{{adminUrl}}")}`,
    textContent:
      "Nutzerantwort zu Ticket {{ticketNumber}}: {{subject}}\n\nVon: {{userDisplayName}} ({{userEmail}})\n\n{{adminUrl}}\n",
    allowedVariables: [
      "ticketNumber",
      "subject",
      "priority",
