/**
 * @file email-webhook-auth.ts
 * @purpose Absicherung des Provider-Webhooks für Zustellstatus (Bounce/Complaint).
 */
...
export function authorizeEmailWebhook(request: Request): {
  authorized: boolean;
  status: 401 | 429;
} {
