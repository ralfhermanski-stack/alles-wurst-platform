/**
 * @file philosophy-placeholder-svg.ts
 * @purpose SVG-Platzhalter für Philosophie-Karten (einheitliches Layout).
 */

export function buildPhilosophyPlaceholderSvg(title: string, subtitle = "Platzhalterbild"): string {
